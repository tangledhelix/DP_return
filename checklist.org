...
- [ ] (html) link ~(note)~ entries in the index instead of using pageno links. (Remove link from page number?)
- [ ] (html) add page/note links from tables at start of book
...
- [ ] Hyperlink page references in text, TOC, and index (discussed [[https://www.pgdp.net/wiki/PPTools/Guiguts/HTML#Hyperlinking_Page_Numbers][here]] and [[https://www.pgdp.net/wiki/Indexes][here]]).
- [ ] Remove the [[https://www.pgdp.net/wiki/PPTools/Guiguts/Guiguts_Manual/HTML_Menu#Generated_TOC][Generated TOC]] if it is not needed.
