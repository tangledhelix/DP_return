...
- [ ] Re-open ~return-utf8.txt~ (if not still open).
*** Convert ~<tb>~, Italic, Bold, and Smallcap
- [ ] ~Text → Convert Markup~:
  - [ ] Convert [[https://www.pgdp.net/wiki/DP_Official_Documentation:Formatting/Formatting_Guidelines#Formatting_at_the_Character_Level:][inline formatting]].
