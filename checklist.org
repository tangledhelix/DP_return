...
* Transcriber Notes
** Leading TN
- Include note about italics & smallcaps for text version.
- The ~^~ or ~^{...}~ notation indicates a superscript
...
*** Process sidenotes
- [ ] For paragraphs with just one sidenote, position it before the paragraph.
- [ ] For paragraphs with multiple sidenotes, will need to decide how to handle them. See the [[https://www.pgdp.net/wiki/Sidenotes][wiki article]], which talks about using Unicode diamond characters, among other ideas.
