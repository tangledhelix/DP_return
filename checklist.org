...
*** Fix Sidenotes
- [ ] Read the [[https://www.pgdp.net/wiki/PPTools/Guiguts/Fixup#Sidenotes][discussion]]. Step through sidenotes with: Search & Replace of ~[S~, not regex, not whole word, ignore case. Click ~Search~ to find each Sidenote.
