...
- [ ] (html) f003: poem with latin?
- [X] p085: ~March 16-May 17~: should be en-dash? Any other cases?
- [ ] (html) p007-p008: latin?
- [ ] (html) p010-p011: latin?
- [ ] (html) p016: latin?
- [ ] (html) p018: latin?
- [ ] (html) p038: poem with latin?
- [ ] (html) p080: latin or french?
- [ ] (html) p085-p086: latin?
- [ ] (html) footnote 18: latin?
- [ ] (html) footnote 22: latin?
- [ ] (html) footnote 49: latin?
- [ ] (html) footnote 96: ~penc̃on~ is what language? non-italic text. uses non-composed character
...
- [ ] Using Regex Library and my ~abbr.json~ file, add ~abbr~ tags as appropriate. ([[https://www.pgdp.net/wiki/Accessibility_Recipes/Abbreviations][Reference]])
*** Table notes
...
#+end_src
*** Process sidenotes
- [ ] Does Guiguts auto-process these somehow from ~[Sidenote: ]~ markup?
- [ ] Decide how to handle these; see the [[https://www.pgdp.net/wiki/Sidenotes][wiki page]].
*** Drop caps
Drop-cap CSS is in my custom header; markup looks like:
#+begin_src html
<p class="drop-cap"><span class="smcap uppercase">The</span>
#+end_src
- [ ] Handle any drop-caps ([[https://www.pgdp.net/wiki/DP_Official_Documentation:PP_and_PPV/Easy_Epub/Dropcaps][wiki]])
