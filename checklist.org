...
- Archaic spellings preserved. Example: “forein” on p. 11, and others.
  - on p. 56, "Duarto en Rigis (Henriques)" and "Duarto an Rigij (Henriques)"
...
- [ ] Click ~Ligatures~. Scan list for [[https://www.pgdp.net/wiki/Æ_and_œ_ligatures][incorrect or inconsistent use]] of ~ae~ and ~oe~ ligatures.
#+begin_src text
