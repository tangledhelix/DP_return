...
- [ ] p129-p132: index
- [ ] Revisit side notes. So far, rejoined them, moved above paras.
...
- [ ] footnote 22: latin?
- [ ] footnote 49: latin?
- [ ] footnote 96: ~penc̃on~ is what language? non-italic text
* Transcriber Notes
** Leading TN
...
- Footnote X: find final footnote number later): changed “6 & 7” to “7 & 8” per erratum in original book. (7 & 8 Vict., cap. 66, sec. 5)
  - [ ] Find final footnote number later
...
- [ ] If the book has poetry that uses line numbers, read [[https://www.pgdp.net/wiki/PPTools/Guiguts/Fixup#Poetry_Line_Numbers][this page]] and align the line numbers consistently.
*** Curly quotes
- [ ] Curly quotes are [[https://www.pgdp.net/phpBB3/viewtopic.php?f=3&t=73290][recommended]] in both the text and HTML versions. Now is the time to put them in, before the split.
