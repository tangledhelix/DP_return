...
- [ ] "Dual-calendar dates with a forward slash please - e.g. 1654/5"
  - Need to evaluate this and handle anything here (if needed)
  - [ ] p037: blockquote heading using fraction-style markup
  - [ ] appears in other places; do a search like ~\d/\d~ to find them.
...
- [ ] f003: poem with latin?
- [X] p085: ~March 16-May 17~: should be en-dash? Any other cases?
- [ ] p007-p008: latin?
- [ ] p010-p011: latin?
- [ ] p016: latin?
- [ ] p018: latin?
- [ ] p038: poem with latin?
- [ ] p080: latin or french?
- [ ] p085-p086: latin?
- [ ] footnote 18: latin?
- [ ] footnote 22: latin?
- [ ] footnote 49: latin?
- [ ] footnote 96: ~penc̃on~ is what language? non-italic text. uses non-composed character
- [ ] link ~(note)~ entries in the index instead of using pageno links. (Remove link from page number?)
- [ ] add page/note links from tables at start of book
* Transcriber Notes
** Leading TN
